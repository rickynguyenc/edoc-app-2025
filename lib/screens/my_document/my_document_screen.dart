...
import 'package:edoc_tabcom/providers/my_document_provider.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    Future<void> _loadMore() async {
      if (hasMore.value && _scrollController.position.pixels == _scrollController.position.maxScrollExtent && !isLoading.value) {
        ...
        try {
          hasMore.value = await ref.read(myDocumentProvider.notifier).getMoreDesktopList(paramPublic);
    ...
    Future<void> _refresh() async {
      ...
      hasMore.value = await ref.read(myDocumentProvider.notifier).getDesktopList(paramPublic);
      isLoading.value = false;
    }

    useEffect(() {
      Future.wait([ref.read(myDocumentProvider.notifier).getDesktopList(paramPublic), ref.read(categoryTreeProvider.notifier).getCategoryTree()]).then((value) {
        isLoading.value = false;
          ...
          Container(
            ...
            child: DropdownSearch<CategoryTreeResonpse>(
              ...
              onChanged: (value) {
                ...
                isLoading.value = true;
                ref.read(myDocumentProvider.notifier).getDesktopList(paramPublic).then((value) {
                  isLoading.value = false;
                  hasMore.value = value;
                });
              },
              ...
              children: [
                ...
                ElevatedButton(
                                ...
                                Container(
                                  ...
                                  child: Material(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () {
                                        context.router.pop();
                                        disPlaySortingType.value = 'Tài liệu công khai';
                                        filterTab.value = 0;
                                        paramPublic = paramPublic.copyWith(type: 'Public', sorting: 'Lastest', skipCount: 0);
                                        isLoading.value = true;
                                        ref.read(myDocumentProvider.notifier).getDesktopList(paramPublic).then((value) {
                                          isLoading.value = false;
                                          hasMore.value = value;
                                ...
                                Container(
                                  ...
                                  child: Material(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () {
                                        context.router.pop();
                                        disPlaySortingType.value = 'Tài liệu bạn đã tạo';
                                        filterTab.value = 1;
                                        paramPublic = paramPublic.copyWith(type: 'CreatedFile', sorting: 'Lastest', skipCount: 0);
                                        isLoading.value = true;
                                        ref.read(myDocumentProvider.notifier).getDesktopList(paramPublic).then((value) {
                                          isLoading.value = false;
                                          hasMore.value = value;
                                ...
                                Container(
                                  ...
                                  child: Material(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () {
                                        context.router.pop();
                                        disPlaySortingType.value = 'Tài liệu bạn đã chia sẻ';
                                        filterTab.value = 2;
                                        paramPublic = paramPublic.copyWith(type: 'SharedFile', sorting: 'Lastest', skipCount: 0);
                                        isLoading.value = true;
                                        ref.read(myDocumentProvider.notifier).getDesktopList(paramPublic).then((value) {
                                          isLoading.value = false;
                                          hasMore.value = value;
                                  ...
                                  child: Material(
                                    ...
                                    child: InkWell(
                                      child: Row(children: [
                                        ...
                                        Text(
                                          'Tài liệu bạn đã được chia sẻ',
                                          style: TextStyle(
                                            color: filterTab.value == 3 ? Color(0xFFEF4444) : Color(0xFF42526D),
                                            fontSize: 16,
                                            fontWeight: FontWeight.w500,
                                            letterSpacing: 0.08,
                                          ),
                                      ...
                                      onTap: () {
                                        context.router.pop();
                                        disPlaySortingType.value = 'Tài liệu bạn đã được chia sẻ';
                                        filterTab.value = 3;
                                        paramPublic = paramPublic.copyWith(type: 'FileBeingShare', sorting: 'Lastest', skipCount: 0);
                                        isLoading.value = true;
                                        ref.read(myDocumentProvider.notifier).getDesktopList(paramPublic).then((value) {
                                          isLoading.value = false;
                                          hasMore.value = value;
                                  ...
                                  child: Material(
                                    ...
                                    child: InkWell(
                                      child: Row(children: [
                                        ...
                                        Text(
                                          'Tài liệu bạn yêu thích',
                                          style: TextStyle(
                                            color: filterTab.value == 4 ? Color(0xFFEF4444) : Color(0xFF42526D),
                                            fontSize: 16,
                                            fontWeight: FontWeight.w500,
                                            letterSpacing: 0.08,
                                          ),
                                      ...
                                      onTap: () {
                                        context.router.pop();
                                        disPlaySortingType.value = 'Tài liệu bạn yêu thích';
                                        filterTab.value = 4;
                                        paramPublic = paramPublic.copyWith(type: 'LikedFile', sorting: 'Lastest', skipCount: 0);
                                        isLoading.value = true;
                                        ref.read(myDocumentProvider.notifier).getDesktopList(paramPublic).then((value) {
                                          isLoading.value = false;
                                          hasMore.value = value;
                                ...
                                Container(
                                  ...
                                  child: Material(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () {
                                        context.router.pop();
                                        disPlaySortingType.value = 'Tài liệu bạn đã tải';
                                        filterTab.value = 5;
                                        paramPublic = paramPublic.copyWith(type: 'DownloadedFile', sorting: 'Lastest', skipCount: 0);
                                        isLoading.value = true;
                                        ref.read(myDocumentProvider.notifier).getDesktopList(paramPublic).then((value) {
                                          isLoading.value = false;
                                          hasMore.value = value;
                  ...
                  child: Row(
                    children: [
                      Text(
                        disPlaySortingType.value == '' ? 'Tài liệu công khai' : disPlaySortingType.value,
                        style: TextStyle(
